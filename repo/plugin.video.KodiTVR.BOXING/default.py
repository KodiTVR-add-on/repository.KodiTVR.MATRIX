...
if __name__ == '__main__':
   ...
   addDir(title=" [COLOR green]●[/COLOR]",url="plugin://plugin.video.youtube/user/"+YOUTUBE_CHANNEL_ID3+"/",thumbnail="https://i.imgur.com/sJIh5MS.png",fanart="https://i.imgur.com/7ZcGsc7.jpg",folder=True )
