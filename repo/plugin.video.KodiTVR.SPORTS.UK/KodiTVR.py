...
addon_id        = 'plugin.video.KodiTVR.SPORTS.UK'
addon           = Addon(addon_id, sys.argv)
AddonTitle      = '[COLORsilver]KodiTVR [COLORred]U[COLORblue]K [COLORsilver]SPORT [COLORblack]TV[/COLOR]'
...
baseurl         = ( 'https://www.dropbox.com/s/whd8k934347n9be/SPORTS%20UK_INDEX.xml?raw=true' )
...
def popup():
        ...
        if len(message)>1:
                ...
                if compfile == message:pass
                        ...
                        showText('[B][I][COLOR red]KodiTVR UK SPORT TV Version 1.0.0 Kodi 19 Matrix[/COLOR][/I][/B]', message)
...
def PLAYLINK(name,url,iconimage):
    ...
    dp.create(AddonTitle,"[COLORred]KodiTVR UK SPORT TV[/COLOR]",'[COLOR red]OPENING LINK[/COLOR]','')   
    dp.update(0)
