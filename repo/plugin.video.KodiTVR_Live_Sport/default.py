...
def Main_menu():
    addDir('[B][COLOR green]KodiTVR | LIVE EVENTS[/COLOR][/B]', Live_url, 5, ICON, FANART, '')
    addDir('[B][COLOR green]KodiTVR | SPORTS[/COLOR][/B]', '', 3, ICON, FANART, '')
    addDir('[B][COLOR green]KodiTVR | BEST LEAGUES[/COLOR][/B]', '', 2, ICON, FANART, '')
    addDir('[B][COLOR yellow]KodiTVR | Settings[/COLOR][/B]', '', 10, ICON, FANART, '')
    addDir('[B][COLOR red]KodiTVR | Version: [COLOR lime]%s[/COLOR][/B]' % vers, '', 'BUG', ICON, FANART, '')
