...
def Main_menu():
    addDir('[B][COLOR white]KodiTVR | LIVE EVENTS[/COLOR][/B]', Live_url, 5, ICON, FANART, '')
    addDir('[B][COLOR white]KodiTVR | SPORTS[/COLOR][/B]', '', 3, ICON, FANART, '')
    addDir('[B][COLOR white]KodiTVR | BEST LEAGUES[/COLOR][/B]', '', 2, ICON, FANART, '')
    addDir('[B][COLOR gold]KodiTVR | Settings[/COLOR][/B]', '', 10, ICON, FANART, '')
    addDir('[B][COLOR gold]KodiTVR | Version: [COLOR lime]%s[/COLOR][/B]' % vers, '', 'BUG', ICON, FANART, '')
