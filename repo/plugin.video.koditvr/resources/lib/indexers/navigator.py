...
class navigator:
    ...
    def tools(self):
        self.addDirectoryItem('[B]KodiTVR[/B] : Changelog', 'changelog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        ...
        self.addDirectoryItem(32079, 'koditvrscrapersettings', 'icon.png', 'DefaultAddonProgram.png', isFolder=False)
