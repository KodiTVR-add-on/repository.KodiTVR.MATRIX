...
if __name__ == '__main__':
   ...
   addDir(title=" [COLORgreen]●[/COLOR]",url="plugin://plugin.video.youtube/user/"+YOUTUBE_CHANNEL_ID3+"/",thumbnail="https://i.imgur.com/SoHE1oA.png",fanart="https://i.imgur.com/AFcDQp6.jpg",folder=True )
