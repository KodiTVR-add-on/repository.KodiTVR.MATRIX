...
addon_id        = 'plugin.video.KodiTVR.SPORTS.USA'
addon           = Addon(addon_id, sys.argv)
AddonTitle      = '[COLORgold]KodiTVR [COLORdarkblue]U[COLORwhite]S[COLORred]A [COLORsilver]SPORT [COLORlime]TV[/COLOR]'
...
baseurl         = ( 'https://www.dropbox.com/s/vhvizf9b6g6shfp/Sports_TUBE.xml?raw=true' )
...
messagetext     = ( 'https://www.dropbox.com/s/0l3qmktax6plmlp/MENSAGEM_BEM%20VINDOS.txt?raw=true') 
dialog          = xbmcgui.Dialog()
                                                               
def GetMenu():
     popup()
     url = baseurl
     addDir('[COLOR thistle]«««««««  [B][COLOR green]KodiTVR News & Updates[/COLOR][/B]  [COLOR thistle]»»»»»»»[/COLOR]',url,6,updatesicon,fanarts)
...
def popup():
        ...
        if len(message)>1:
                ...
                if compfile == message:pass
                        ...
                        showText('[B][I][COLOR red]KodiTVR USA SPORT TV Version 1.0.0 Kodi 19 Matrix[/COLOR][/I][/B]', message)
...
def PLAYLINK(name,url,iconimage):
    ...
    dp.create(AddonTitle,"[COLORred]KodiTVR USA SPORT TV[/COLOR]",'[COLOR red]OPENING LINK[/COLOR]','')   
    dp.update(0)
