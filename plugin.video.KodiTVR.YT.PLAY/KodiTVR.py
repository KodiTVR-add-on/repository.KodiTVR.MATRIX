...
addon_id        = 'plugin.video.KodiTVR.YT.PLAY'
addon           = Addon(addon_id, sys.argv)
AddonTitle      = '[COLORgold]KodiTVR [COLORdarkblue]CINE [COLORsilver]TV [COLORred]PLAY[/COLOR]'
...
baseurl         = ( 'https://www.dropbox.com/s/ctw8g6s4jm0x39l/KodiTVR%20CINE%20YT_INDEX.xml?raw=true' )
...
def popup():
        ...
        if len(message)>1:
                ...
                if compfile == message:pass
                        ...
                        showText('[B][I][COLOR red]KodiTVR CINE TV PLAY Version 1.0.0 Kodi 19 Matrix[/COLOR][/I][/B]', message)
...
def PLAYLINK(name,url,iconimage):
    ...
    dp.create(AddonTitle,"[COLORred]KodiTVR CINE TV PLAY[/COLOR]",'[COLOR red]OPENING LINK[/COLOR]','')   
    dp.update(0)
