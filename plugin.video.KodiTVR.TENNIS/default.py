...
if __name__ == '__main__':
   ...
   addDir(title=" [COLOR cyan]TENNIS[/COLOR]",url="plugin://plugin.video.youtube/user/"+YOUTUBE_CHANNEL_ID3+"/",thumbnail="https://yt3.ggpht.com/-4gwsDPowJJs/AAAAAAAAAAI/AAAAAAAAAAA/u5ZcdysON7k/s288-mo-c-c0xffffffff-rj-k-no/photo.jpg",fanart="https://i.imgur.com/P8uq0XV.jpg",folder=True )
